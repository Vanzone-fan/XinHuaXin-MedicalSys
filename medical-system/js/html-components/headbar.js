 ...
 * @LastEditTime: 2024-07-27 17:27:59
 * @FilePath: \XinHuaXin-MedicalSys\js\html-components\headbar.js
                        ...
                        <div class="topbar">
                            ...
                            <ul class="topbar-right">
                                <li class="dropdown dropdown-profile">
                                    ...
                                    >
                                        <li>
                                            <a href="lyear_pages_profile.html"
                                                ><i class="mdi mdi-account"></i>
                                                个人信息</a
                                            >
                                        </li>
                                        <li>
                                            <a href="lyear_pages_edit_pwd.html"
                                                ><i
...
// 将侧边栏插入到页面中
document.querySelector(".headbar-container").innerHTML = createHeadbar();
